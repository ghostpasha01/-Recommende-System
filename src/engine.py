...
## to run the indiviual models (with train-test data)
...
reccomendation_1 = get_recommendations(final_model,17017,items,user_to_product_interaction,user_to_index_mapping,product_to_feature_interaction)
print(reccomendation_1)
